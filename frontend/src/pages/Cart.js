...
const Cart = () => {
    ...
    const fetchData = async () => {
        console.log("Fetching data..."); // Log to check if the function is being called
        ...
        console.log("Response Data:", responseData); // Log to check response
    ...
    const handlePayment = async () => {
      ...
      console.log(process.env.REACT_APP_STRIPE_PUBLIC_KEY)
        ...
        console.log("Cart Items:", data); // Log cart items before sending the request
        const response = await fetch(SummaryApi.payment.url, {
            ...
            body: JSON.stringify({ cartItems: data }), // Send the correct data
        });
        ...
        console.log("Payment Response:", responseData); // Log payment response

        if (responseData.success) {
            // Handle successful payment here (e.g., redirect to success page)
        } else {
