...
const HorizontalCardProduct = ({category, heading}) => {
  ...
  return (
    <div className='container mx-auto px-4 my-7 relative w-[90%]'>
           ...
           {   loading ? (
                loadingList.map((product,index)=>{
                    return(
                        <div className='w-full min-w-[290px] md:min-w-[330px] max-w-[290px] md:max-w-[330px] h-36 bg-white rounded-sm shadow flex'>
